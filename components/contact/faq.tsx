...
const faqs = [
  {
    ...
    a: "Most custom pieces take 7–10 working days from design approval to delivery. Larger items or bulk orders can take 4–6 weeks. We'll always confirm your timeline before starting.",
  },
  {
